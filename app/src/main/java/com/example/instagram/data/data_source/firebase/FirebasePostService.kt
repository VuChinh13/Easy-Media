...
import com.example.instagram.data.data_source.cloudinary.CloudinaryService
import com.example.instagram.data.model.Comment
import com.example.instagram.data.model.Like
    ...
    override suspend fun getAllPosts(): List<Post> {
        return try {
            val snapshot = db.collection("posts")
                ...
                .orderBy(FieldPath.documentId(), Query.Direction.DESCENDING) // tránh trùng createdAt
                .get()
                .await()
